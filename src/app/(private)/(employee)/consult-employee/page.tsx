    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center py-8">
      <div className="w-full max-w-5xl px-6">
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          {/* Perfil / Logout */}
          <div className="bg-card rounded-lg shadow-md border px-4 py-2 flex flex-col gap-3 absolute right-6 top-6 min-w-52">
            <div className="flex gap-2 items-center">
              <Avatar className="size-14 bg-accent">
                <AvatarImage src="/assets/fiohomem.png" alt="Avatar" />
                <AvatarFallback></AvatarFallback>
              </Avatar>
              <div className="flex flex-col text-md">
                <span className="font-semibold">Cauã R.</span>
                <span className="text-muted-foreground text-sm">Funcionário</span>
              </div>
            </div>
            <div className="mt-2 border-t pt-3 w-full text-center">
              <a href="/#home">
        ...
        <div className="flex gap-8 border-b pb-3 mb-6 overflow-x-auto flex-nowrap scroll-smooth scrollbar-none">
          {dias.map((d, i) => (
            <div
              ...
              className={`flex-shrink-0 flex flex-col items-center font-semibold cursor-pointer transition-colors ${
                i === diaAtivo ? "text-primary scale-110" : "text-foreground hover:text-primary/70"
              }`}
            >
              <span className="text-lg">{d.dia}</span>
              <span
                className={`text-sm ${
                  i === diaAtivo ? "text-primary font-bold" : "text-muted-foreground"
                }`}
              >
                {d.mes}
              </span>
        ...
        <div className="space-y-10">
          ...
          <div>
            <div className="flex gap-4 mb-3">
              <Avatar className="w-14 h-14 bg-[#d6e0ef]">
                <AvatarImage src="/assets/gustavo.png" alt="Avatar" />
